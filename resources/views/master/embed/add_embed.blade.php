...
<div class="col-sm-12">
        @if(!empty(\Session::get('success')) > 0)
          ...
          <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        ...
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                ...
                                <li class="breadcrumb-item active">Konten Add
                                </li>
                            </ol>
                        </div>
                    </div>
              ...
              <div class="card-body">
                <form class="form" action="<?php echo url("/create_embed"); ?>" method="POST" enctype="multipart/form-data">
                <!-- /.card-header -->
                {{csrf_field()}}
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="menu" id="category">
                    ...
                    <div class="col-md-6">
                    <div class="form-group">
                    <label for="course" class="form-label">Sub Menu</label>
                        <select class="form-control" name="course" id="course"></select></div>
                    </div>

                    <div class="col-md-12">
                    <div class="form-group">
                    <label class="form-label">Name </label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name Konten" required>
                    </div>
                    </div>
                    ...
                    <label class="form-label">Iframe </label>
                        <textarea class="form-control" id="iframe" name="iframe" id="editor" required></textarea>
                    </div>
                    </div>
                    ...
                    <textarea class="form-control" id="iframe" name="content" id="editor" required></textarea>
                    </div></div>
                    <!-- /.col -->
