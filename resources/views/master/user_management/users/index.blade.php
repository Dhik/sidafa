              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                  ...
                  <div class="card">
							...
							<a class="btn btn-info btn-sm" href="<?php echo url('/register'); ?>">
							...
							<?php $no++; ?>
								<tr>
									...
									<td>{{$lk->email}}</td>
									<td>
									<a class="btn btn-info btn-sm" href="<?php echo url('/edit_users/'.$lk->id); ?>">
									<i class="menu-livicon" data-icon="pencil">
										...
										<!-- Modal -->
												...
												<div class="modal-content">
													...
													<a href="<?php echo url('/destroy_users/'.$lk->id); ?>" class="btn btn-danger btn-sm confirmation" >Hapus Data</a>
                  ...
                  <div class="card">
							...
							<?php $no++; ?>
								<tr>
									<td>{{$r->role_user}}</td>
									<td>
									<a class="btn btn-info btn-sm" href="<?php echo url('/roles/edit/'.$r->id); ?>">
									<i class="menu-livicon" data-icon="pencil"></i>
										</a>
                                        @if($r->id > 6)
                                        <button type="button" class="btn btn-danger btn-sm confirmation" data-toggle="modal" data-target="#myModalroles{{$r->id}}"><i class="menu-livicon" data-icon="trash"></i></button>
										<!-- Modal -->
												...
												<div class="modal-content">
													...
													<div class="modal-footer">
													<a href="<?php echo url('/roles/destroy/'.$r->id); ?>" class="btn btn-danger btn-sm confirmation" >Hapus Data</a>
