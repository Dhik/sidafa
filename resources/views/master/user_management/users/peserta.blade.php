          ...
          <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="breadcrumbs-top">
                        ...
                        <div class="breadcrumb-wrapper d-none d-sm-block">
                            <ol class="breadcrumb p-0 mb-0 pl-1">
                                ...
                                <li class="breadcrumb-item active">Users Peserta
                                </li>
                            </ol>
                        </div>
                    </div>
              ...
              <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home" role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">Peserta</a>
                  </li>
                  ...
                  <div class="card">
							...
							<?php $no++; ?>
								<tr>
									...
									<td>{{$lk->email}}</td>
									<td>
									<a class="btn btn-info btn-sm" href="<?php echo url('/edit_peserta/'.$lk->id); ?>">
									<i class="menu-livicon" data-icon="pencil">
										...
										<!-- Modal -->
												...
												<div class="modal-content">
													...
													<a href="<?php echo url('/destroy_peserta/'.$lk->id); ?>" class="btn btn-danger btn-sm confirmation" >Hapus Data</a>
