...
<div class="col-sm-12">
        @if(!empty(\Session::get('success')) > 0)
          ...
          <div class="content-header-left col-12 mb-2 mt-1">
              ...
              <div class="card-body">
                <form class="form" action="<?php echo url("/update_trainer/$us->id"); ?>" method="POST" enctype="multipart/form-data">
                <!-- /.card-header -->
                {{csrf_field()}}
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>NIP *</label>
                        <input type="text" class="form-control" id="nip" name="nip" value="{{$us->nip}}" required>
                      </div>
                    </div>
                    <!-- /.col -->
                    <div class="col-md-6">
